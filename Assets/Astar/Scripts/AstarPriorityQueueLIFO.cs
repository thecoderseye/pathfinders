...
namespace Astar
{
    ...
    /// </summary>
    public class AstarPriorityQueueLIFO : IAstarPriorityQueue
    {
        ...
        bool IAstarPriorityQueue.TryDequeue(out Astar.AstarNode node)
        {
            ...
            if (enumerator.MoveNext()) //todo: retrieve the first LinkedList in the dictionary
            {
